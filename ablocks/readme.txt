...
* Fixed – Search block loading issues
* Fixed – Hotspot block position responsive issues
* Fixed – Content-timeline block date connector issues
* Fixed – Table block hover color issues
* Fixed – Info-Box block hover issues
* Fixed – Form block CSS issues
* Improved – Added link support for Advanced list block
* Improved – Added link and width support for image scroll block
* Improved – Added evergreen feature for countdown block

= 2.8.1 - 23/04/2026 =
* Added – Kodezen Store License support
...
* Fixed - Cache plugin compatibility issues
...
* Fixed - Container Margin Left and right not working
* Fixed - Academy LMS & StoreEngine Integration Block Control issue
* Fixed - QR Code block issue 
* Fixed - Search Block Background not working issue
* Fixed - Advance List Block issue 
...
* Added - Popup Builder inside theme builder
* Improved - Form Builder Child Block Improvement
* Improved - Reduce child block css file for better optimized
* Fixed - Device Responsive issue
* Fixed - FSE theme assets generation issue
...
= 1.6.2 - 07/02/2025 =
* Fixed - PCP Plugin Issue

= 1.6.1 - 03/02/2025 =
* Fixed - Container Block Full width, alignment and width issue
* Fixed - Transform Unit Select issue
* Improved - Every Block ID saving logic 

= 1.6.0 - 29/01/2025 =
* Added - New Image Scroller Block
* Added - Background Overlay Control
* Added - Tab Block Auto Play & Sub Text show option
* Fixed - Reset attribute saved issue
* Fixed - Spacer Block Hight Responsive issue
* Fixed - Typography, Text Stoke Range & Unit value issue

= 1.5.15 - 22/01/2025 =
* Added - New News Ticker block
* Added - Demo Importer
* Added - Quick Container and Demo Importer option 
* Added - Button block shadow control
* Fixed - Counter Block Unit Hide & Responsive issue
* Fixed - Divider Block Range & Unit value issue
* Fixed - Image Comparison responsive issue
* Fixed - Advance panel Background color not working

= 1.5.14 - 15/01/2025 =
* Fixed - Container width & alignment issue

= 1.5.13 - 14/01/2025 =
* Fixed - Container parent class issue

= 1.5.12 - 13/01/2025 =
* Improved - Sidebar Settings Button Hover 
* Fixed - Control unit hide issue
* Fixed - Divider Block frontend color issue
* Fixed - Menu block mobile responsive control
* Fixed - Container Block Width issue

= 1.5.11 - 01/01/2025 =
* Added - New PayPal Block
* Fixed - Search Block Issue
