...
class Block extends BlockBaseAbstract {
	...
	public function build_css_v1( $attributes ) {
		...
		$css_generator->add_class_styles(
			...
			$css_generator->custom_device_map( function ( $device ) use ( $attributes ) { return array_merge( Icon::get_wrapper_css( $attributes, $device ), $this->get_icon_spacing_margins( $attributes, $device ) ); } )
		);
		$css_generator->add_class_styles(
	...
	public function build_css_v2( $attributes ) {
		...
		$css_generator->add_class_styles(
          ...
          .ablocks-block--divider .ablocks-block-container',
			...
			$this->get_divider_container_css( $attributes, 'Tablet' ),
			$this->get_divider_container_css( $attributes, 'Mobile' ),
			$css_generator->custom_device_map( function ( $device ) use ( $attributes ) { return $this->get_divider_container_css( $attributes, $device ); } )
		);
		...
		$css_generator->add_class_styles(
			...
			$this->get_divider_element_text_css( $attributes, 'Tablet' ),
			$this->get_divider_element_text_css( $attributes, 'Mobile' ),
			$css_generator->custom_device_map( function ( $device ) use ( $attributes ) { return $this->get_divider_element_text_css( $attributes, $device ); } )
		);
		// Icon Style
		$css_generator->add_class_styles(
			'{{WRAPPER}}  .ablocks-divider__element-icon .ablocks-icon-wrap',
