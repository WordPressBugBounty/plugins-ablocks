	...
	public function build_css( $attributes ) {
		$css_generator = new CssGeneratorV2( $attributes, $this->block_name );
			...
			$css_generator->add_class_styles(
				...
				$css_generator->custom_device_map( function ( $device ) use ( $attributes ) { return $this->get_button_text_css( $attributes, $device ); } )
			);
			$css_generator->add_class_styles(
				...
				$css_generator->custom_device_map( function ( $device ) use ( $attributes ) { return $this->get_button_text_hover_css( $attributes, $device ); } )
			);
		$css_generator->add_class_styles(
