            ...
            foreach ( $active_taxonomy as $taxonomy ) :
                ...
                foreach ( $term_ids as $term_id ) :
                   ...
                   $term_link  = get_term_link( $term );
                    ...
                    $first_post_link = ! empty( $first_post ) ? get_permalink( $first_post[0]->ID ) : '';
                    ...
                    <?php if ( $use_accordion ) : ?>
                        ...
                        <?php if ( $link_url ) : ?><a class="ablocks-taxonomy-title__link" href="<?php echo esc_url( $link_url ); ?>"><?php endif; ?>
